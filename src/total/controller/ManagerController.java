...
public class ManagerController {
	...
	public String addCarHandle(HttpServletRequest req, HttpSession session, @RequestParam Map<String, String> param,
			Model model, @RequestParam(name = "img") MultipartFile img) {
		if (!lvCheck(session)) {
			return "redirect:/";
		}
	...
	public String managerReserveHandle(HttpSession session, Model model, 
	...
	public String memberHandle(HttpSession session, Model model, 
							@RequestParam(defaultValue = "") String key) {
