...
<div class="container">  
<h2>현재 회원</h2>        
<form><p align="right" ><span class="glyphicon glyphicon-search"></span> <input style="height:30px" name="key" autocomplete="off" value="${key }" placeholder="아이디 or 이메일"/> 
	<button type="button" id="b" class="btn btn-danger"><small>회원 강퇴</small></button>
	<button type="button" id="m" style="margin-right:228px" class="btn btn-success" ><small>메세지 전송</small></button>
</form>
