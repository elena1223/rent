...
<div class="container">
  ...
  <p align="right" ><button type="button" id="myb" style=" margin-right:228px" class="btn btn-danger">예약취소</button><p>
  </form>
</div>
<div class="container">
<h3>취소요청</h3>
  ...
  <p align="right" ><button type="button" id="cancelb" style=" margin-right:228px" class="btn btn-warning">요청취소</button><p>
  </form>
 </div>
 <div class="container">
  <h3>종료된 예약</h3>
